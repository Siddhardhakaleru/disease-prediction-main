...
diabetes_model_path = os.path.join(BASE_DIR, "training_modules", "diabetes_model.sav")
heart_model_path = os.path.join(BASE_DIR, "training_modules", "heart_model.sav")
parkinson_model_path = os.path.join(BASE_DIR, "training_modules", "parkinson.sav")
